...
const SettingsPage = () => {
  ...
  const [profilePhoto, setProfilePhoto] = useState('https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Page Title */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-blue-900 mb-2">{t('systemSettings')}</h2>
          <p className="text-gray-700 mb-4">{t('configure')}</p>
        ...
        {activeTab === 'profile' && (
          <div className="border-2 border-gray-300 bg-white p-8 space-y-6">
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-6">{t('profilePhoto')}</h3>
              <div className="flex items-center gap-8">
                <div className="relative">
                  <img src={profilePhoto} alt="Profile" className="w-32 h-32 rounded-full border-4 border-blue-900 object-cover" />
                ...
                <div>
                  <p className="font-semibold text-gray-800 mb-2">{profileData.firstName} {profileData.lastName}</p>
                  <p className="text-sm text-gray-600 mb-4">{profileData.designation}</p>
                  <label className="bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-6 inline-flex items-center gap-2 cursor-pointer transition-colors">
                    <Camera size={16} />
                    {t('changePhoto')}
                    <input type="file" accept="image/*" onChange={handlePhotoChange} className="hidden" />
                  </label>
            ...
            <div className="border-t-2 border-gray-300 pt-6">
              <h3 className="text-xl font-bold text-blue-900 mb-6">{t('personalInfo')}</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('firstName')}</label>
                  <input type="text" value={profileData.firstName} onChange={(e) => handleProfileChange('firstName', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('lastName')}</label>
                  <input type="text" value={profileData.lastName} onChange={(e) => handleProfileChange('lastName', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('email')}</label>
                  <input type="email" value={profileData.email} onChange={(e) => handleProfileChange('email', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('phone')}</label>
                  <input type="tel" value={profileData.phone} onChange={(e) => handleProfileChange('phone', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('designation')}</label>
                  <input type="text" value={profileData.designation} disabled className="w-full px-4 py-3 border-2 border-gray-300 bg-gray-100 text-gray-700" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('region')}</label>
                  <input type="text" value={profileData.region} disabled className="w-full px-4 py-3 border-2 border-gray-300 bg-gray-100 text-gray-700" />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t('officeLocation')}</label>
                  <input type="text" value={profileData.officeLocation} onChange={(e) => handleProfileChange('officeLocation', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700" />
                </div>
              </div>
            </div>
            <div className="border-t-2 border-gray-300 pt-6">
              <button onClick={handleSave} className="bg-blue-900 hover:bg-blue-800 text-white font-bold py-3 px-8 flex items-center gap-2 transition-colors">
        ...
        {activeTab === 'notifications' && (
          <div className="border-2 border-gray-300 bg-white p-8 space-y-6">
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-6">{t('notificationPrefs')}</h3>
        ...
        {activeTab === 'security' && (
          <div className="border-2 border-gray-300 bg-white p-8 space-y-6">
            <div className="bg-blue-50 border-l-4 border-blue-900 px-6 py-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-blue-900">{t('securityAlert')}</p>
                <p className="text-sm text-blue-800 mt-1">{t('lastLogin')}</p>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-6">{t('securitySettings')}</h3>
              <div className="space-y-6">
                <div className="border-2 border-gray-300 p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-bold text-gray-800">{t('changePassword')}</p>
                ...
                <div className="border-2 border-gray-300 p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="font-bold text-gray-800">{t('twoFactor')}</p>
                ...
                <div className="border-2 border-gray-300 p-6">
                  <label className="block font-bold text-gray-800 mb-3">{t('sessionTimeout')}</label>
                  <select value={securitySettings.sessionTimeout} onChange={(e) => handleSecurityChange('sessionTimeout', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700 bg-white">
                    <option>15</option>
                    <option>30</option>
                    <option>60</option>
                    <option>120</option>
                ...
                <div className="border-2 border-gray-300 p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-bold text-gray-800">{t('loginAlerts')}</p>
                      <p className="text-sm text-gray-600 mt-1">{t('loginAlertsDesc')}</p>
                    </div>
        ...
        {activeTab === 'system' && (
          <div className="border-2 border-gray-300 bg-white p-8 space-y-6">
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-6">{t('systemPrefs')}</h3>
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">{t('theme')}</label>
                    <select value={systemSettings.theme} onChange={(e) => handleSystemChange('theme', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700 bg-white">
                  ...
                  <div>
                    ...
                    <select value={systemSettings.language} onChange={(e) => handleSystemChange('language', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700 bg-white">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">{t('dateFormat')}</label>
                    <select value={systemSettings.dateFormat} onChange={(e) => handleSystemChange('dateFormat', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700 bg-white">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">{t('timezone')}</label>
                    <input type="text" value={systemSettings.timezone} disabled className="w-full px-4 py-3 border-2 border-gray-300 bg-gray-100 text-gray-700" />
                  </div>
                </div>
                <div className="border-t-2 border-gray-300 pt-6">
                  <div className="flex items-center justify-between p-4 border-2 border-gray-300 bg-gray-50">
                    <div>
                      <p className="font-bold text-gray-800">{t('autoRefresh')}</p>
                      <p className="text-sm text-gray-600 mt-1">{t('autoRefreshDesc')}</p>
                    </div>
                  ...
                  {systemSettings.autoRefresh && (
                    <div className="mt-4">
                      <label className="block text-sm font-semibold text-gray-700 mb-2">{t('refreshInterval')}</label>
                      <select value={systemSettings.refreshInterval} onChange={(e) => handleSystemChange('refreshInterval', e.target.value)} className="w-full px-4 py-3 border-2 border-gray-300 focus:border-blue-900 focus:outline-none text-gray-700 bg-white">
