...
export default function Login({ onLogin = () => {}, lang = 'en', setLang = () => {}, theme = 'light', setTheme = () => {} }) {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 items-center bg-blue-800 rounded-lg p-2">
              <Globe size={20} />
              <button onClick={() => handleChangeLanguage('en')} className={`px-4 py-2 rounded font-bold transition-all ${currentLang === 'en' ? 'bg-white text-blue-900' : 'bg-transparent text-white hover:bg-blue-700'}`}>
                English
              </button>
              <button onClick={() => handleChangeLanguage('mr')} className={`px-4 py-2 rounded font-bold transition-all ${currentLang === 'mr' ? 'bg-white text-blue-900' : 'bg-transparent text-white hover:bg-blue-700'}`}>
                मराठी
              </button>
            </div>
          </div>
